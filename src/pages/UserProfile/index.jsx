...
import { UserProfileInput } from 'src/components/userProfile/Input'
import { ModalDeposit } from 'src/components/userProfile/ModalDeposit'
import { ModalWithdraw } from 'src/components/userProfile/ModalWithDraw'
import useAuth from 'src/store/hooks/authentication'
import { apiGetConfig } from 'src/store/sagas/authentication'
...
export const UserProfile = () => {
  ...
  const onClickConnectWallet = async () => {
    ...
    if (res.status === 200) {
      setWalletAddress(res.ETH_DEPOSIT_ADDRESS)
    }
  }
  ...
  return (
    ...
    >
      ...
      <ModalWithdraw open={openWithdraw} setOpen={setOpenWithdraw} walletAddress={walletAddress} />
    </Row>
  )
}

...
export const SUBMIT_BET_BATCH = `${SLICE_LOTTERY}/submitBetBatch`
export const SUBMIT_BET_BATCH_SUCCESS = `${SLICE_LOTTERY}/submitBetBatchSuccess`
export const SUBMIT_BET_BATCH_FAILED = `${SLICE_LOTTERY}/submitBetBatchFailed`
